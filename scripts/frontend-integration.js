 ...
 * This file demonstrates how to integrate Defiforge with a web frontend
 */

// For React/Vue/Angular applications
export class DefiforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DefiforgeClient(provider, contractAddress);
